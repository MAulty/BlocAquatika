...
public class Atoll_SurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

    public Atoll_SurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> p_i51315_1_) {
        super(p_i51315_1_);
    }
